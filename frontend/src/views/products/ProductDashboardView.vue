<template>
  <div class="dashboard-container">
    ...
    <section v-if="isAdmin" class="dashboard-section admin-section">
      ...
      <button @click="triggerBatchUpdate('deposit')" :disabled="isUpdating">Update Deposit Products</button>
      <button @click="triggerBatchUpdate('saving')" :disabled="isUpdating">Update Saving Products</button>
      <button @click="triggerBatchUpdate('mortgage_loan')" :disabled="isUpdating">Update Mortgage Loans</button>
      <button @click="triggerBatchUpdate('credit_loan')" :disabled="isUpdating">Update Credit Loans</button>
      <div v-if="isUpdating" class="loading-message">Updating...</div>
      <div v-if="updateStatus" :class="{'success-message': updateStatus.success, 'error-message': !updateStatus.success}">
